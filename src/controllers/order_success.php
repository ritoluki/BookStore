...
<body>
    <div class="success-container">
        ...
        <div class="success-header"
            style="background: <?php echo $payment_status == 'success' ? 'linear-gradient(135deg, #28a745 0%, #20c997 100%)' : ($payment_status == 'failed' ? 'linear-gradient(135deg, #dc3545 0%, #c82333 100%)' : 'linear-gradient(135deg, #ffc107 0%, #e0a800 100%)'); ?>">
            <div class="success-icon">
                <i
                    class="fas fa-<?php echo $payment_status == 'success' ? 'check-circle' : ($payment_status == 'failed' ? 'times-circle' : 'clock'); ?>"></i>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h4>Trạng thái</h4>
                        <span
                            class="status-badge status-<?php echo strtolower($order['trangthai'] == 0 ? 'pending' : ($order['trangthai'] == 1 ? 'processing' : ($order['trangthai'] == 2 ? 'shipping' : ($order['trangthai'] == 3 ? 'completed' : 'cancelled')))); ?>">
                            <?php
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <span
                                class="status-badge status-<?php echo $payment_status == 'success' ? 'completed' : 'cancelled'; ?>">
        ...
        <div class="order-summary">
            ...
            $phigiaohang = isset($order['phigiaohang']) ? (float) $order['phigiaohang'] : 30000; // Mặc định 30k nếu không có trong DB
            $tongtien_sanpham = $order['tongtien'] - $phigiaohang; // Tổng tiền sản phẩm = tổng tiền - phí ship
            ?>
            <div class="summary-item">
                <span class="summary-label">Tổng tiền sản phẩm:</span>
                <span class="summary-value"><?php echo formatCurrency($tongtien_sanpham); ?></span>
            </div>
            <?php if ($giamgia > 0): ?>
                <div class="summary-item">
        ...
        <div class="action-buttons">
            ...
            <?php if ($payment_status == 'failed'): ?>
                <button
                    onclick="retryVNPayPayment('<?php echo htmlspecialchars($order['id']); ?>', <?php echo $order['tongtien']; ?>)"
                    class="btn-secondary" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%);">
